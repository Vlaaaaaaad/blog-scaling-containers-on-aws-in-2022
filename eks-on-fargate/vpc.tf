...
resource "aws_security_group_rule" "vpc_endpoints_from_myapp" {
  security_group_id = aws_security_group.vpc_endpoints.id
  description       = "Allow traffic from the myapp"
...
resource "aws_security_group_rule" "vpc_endpoints_from_all_base" {
  security_group_id = aws_security_group.vpc_endpoints.id
  description       = "Allow traffic from all pods (base SG)"
  ...
  source_security_group_id = aws_security_group.sg_per_pod_all.id
}
